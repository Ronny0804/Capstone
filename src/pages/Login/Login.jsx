...
// console.log(menuValues.value.value)
  ...
  const addData = async () => {
    ...
    console.log(templateValues?.value?.component);
    ...
    await setDoc(doc(firestore, db.userTemplate, form.hotelname), {
      ...
      ourbagImg: ourImgValues.value.value ? ourImgValues.value.value : [],
      // ourImg: ourImg ? ourImg : [],
    })
      ...
      <div className="container my-5">
        ...
        <form className="pt-5">
          ...
          <div className="container border border-dark p-4 border-2 my-5 rounded">
            <h3>Why Choose us</h3>
            <div className="mb-3">
              <label className="form-label">Service 1</label>
              <input
                type="text"
                className="form-control"
            ...
            <div className="mb-3">
              <label className="form-label">Service 2</label>
              <input
                type="text"
                className="form-control"
            ...
            <div className="mb-3">
              <label className="form-label">Service 3</label>
              <input
                type="text"
                className="form-control"
          ...
          <div className="container border border-dark p-4 border-2 my-5 rounded">
            <div className="mb-3 d-flex flex-column justify-content-around align-items-start">
              <h4 className="form-label">Our Image</h4>
          ...
          <div className="container border border-dark p-4 border-2 my-5 rounded">
            <div className="mb-3 d-flex flex-column justify-content-around align-items-start">
              <h4 className="form-label">Background Image</h4>
